...
public class FolderChooserDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		String folder_name = sharedPreferences.getString(PreferenceKeys.getSaveLocationPreferenceKey(), "OnePlusCamera");
		if( MyDebug.LOG )
		...
		if( !canWrite() ) {
			...
			// note that we reset to DCIM rather than DCIM/OnePlusCamera, just to increase likelihood of getting back to a valid state
